...
(function() {
  var APP_ID, CLIENT_ID, Comment, KEYCODES, Thread, User, authorize, decodeState, init_share, initializeModel, model, onFileLoaded, realtimeUtils, register_types, start, state, users;
  ...
  start = function() {
    ...
    if (id) {
      ...
      return realtimeUtils.createRealtimeFile('New Wave Comments File', function(createResponse) {
